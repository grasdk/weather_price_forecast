# py-yr.no-weather
Simple python program to download weather yr.no forecast following their requirements on: https://developer.yr.no/doc/locationforecast/HowTO/
